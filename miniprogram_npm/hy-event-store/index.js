...
__DEFINE__(1648988148824, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648988148825,"./event-store":1648988148826}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648988148825, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648988148826, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648988148825,"./utils":1648988148827}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648988148827, function(require, module, exports) {
...
return __REQUIRE__(1648988148824);
})()
